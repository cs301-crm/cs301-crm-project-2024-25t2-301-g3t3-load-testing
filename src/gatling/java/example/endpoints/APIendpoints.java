...
//  }
                                    ...
                                    """
                                            {
                                                ...
                                                "verificationDocumentUploaded": "#{verificationDocumentUploaded}"
                                            }
                                            """
                            )
                    )
    ...
    // Define read all clients request
    public static final HttpRequestActionBuilder readAllClient =
            http("ReadClient")
                    .get("/client")
                    .header("Content-Type", "application/json")
                    .header("Authorization", "Bearer #{JWT_TOKEN}")
    ...
    // Define update client request
    public static final HttpRequestActionBuilder updateClient =
            http("UpdateClient")
    ...
    // Define delete client request
    public static final HttpRequestActionBuilder deleteCLient =
            http("DeleteClient")
